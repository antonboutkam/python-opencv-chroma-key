...
BACKGROUND_PATH = "loops/background3.mp4"
...
if autoHsv:
    ...
    for x in range(200):
        ...
        # Add a small blurr for the avg color detection
        frame_fg = cv2.GaussianBlur(frame_fg, (5, 5), 0)
...
while True:
    ret_fg, frame_fg = cap_foreground.read()
    frame_bg = cv2.imread('textures/skeleton6.jpg')
